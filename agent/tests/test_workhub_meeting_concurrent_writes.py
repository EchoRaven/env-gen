...
class ConcurrentMeetingDecisionWritesReproduce(unittest.TestCase):
    ...
    def setUp(self) -> None:
        ...
        self.reg.workhub.create_document(
            title="unrelated",
            kind="design",
            agent="orchestrator",
        )
        ...
        self.assertIn(
            self.meeting_id,
            self.reg.workhub.stores.documents.value(),
    ...
    def test_concurrent_decisions_from_4_lanes_all_persist(self):
        ...
        pages = self.reg.workhub.stores.documents.value()
        self.assertIn(
    ...
    def test_concurrent_add_decision_plus_archive_keeps_meeting(self):
        ...
        results = {}
        def archiver():
            results["archive"] = self.reg.workhub.archive_document(
    ...
    def test_multiprocess_hub_registry_construction_does_not_wipe_pages(self):
        ...
        pages = post.workhub.stores.documents.value()
        self.assertIn(
            self.meeting_id, pages,
