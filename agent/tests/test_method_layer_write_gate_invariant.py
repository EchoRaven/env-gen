...
Authoritative count: ``METHOD_ALLOWLIST`` currently has **26 entries**
...
class TestMethodLayerWriteGateInvariant(unittest.TestCase):
    ...
    def test_method_allowlist_count_is_23(self) -> None:
        ...
        self.assertEqual(
            ...
            26,
            f"METHOD_ALLOWLIST count drifted from comment-pinned 26 "
