...
_CONTRACT_READ_TOOLS = (
    ...
    # #346: "registryhub_get_table" was listed here and matches NO registered
    # tool, so the force-offer (always_include & candidate_names) always dropped
    # it -- the pin has been a no-op since it was written, and the read
    # capability this file protects came from the other three. Asserting it kept
    # a fiction green. The real table read is registryhub_list_tables below.
